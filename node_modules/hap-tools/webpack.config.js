...
const WebpackZipPlugin = require('./packager/webpack-zip-plugin')
const WebpackHandlerWrapPlugin = require('./packager/webpack-handler-wrap-plugin')
const info = require('./packager/info')
const moduleName = require('./package.json').name

const argv = yargs.argv

// 暂时暴露全局
global.colorconsole = utils.colorconsole
...
webpackConf = {
  ...
  module: {
    loaders: [
      ...
      {
        test: /\.js/,
        loaders: [path.resolve(__dirname, 'packager', 'module-loader.js'), 'babel'],
  ...
  plugins: [
    ...
    // 编译时间计时
    function() {
      this.plugin( argv.watch ? 'watch-run' : 'run', function(compiler, callback) {
